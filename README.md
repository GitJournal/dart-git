...
Therefore, this is an experimental start at reimplementing Git in Dart. Right now the plan is to just implement to subset of features required by GitJournal.
