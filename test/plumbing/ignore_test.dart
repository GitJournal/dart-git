...
import 'package:dart_git/plumbing/ignore.dart';

void main() {
  test('TestSimpleMatch_inclusion', () {
    var p = Ignore(['!vul?ano']);

    expect(p.ignores("value"), false);
    expect(p.ignores("vulkano"), false);
    expect(p.ignores("tail"), false);
  });
